...
import Canvas, { Arc, Line, Text , useCanvasState } from "../components/Canvas";
...
import "./PolarDemo.scss";

export default function PolarDemo() {
	...
	return (
		<Canvas zoom={2} center={{ x:0 , y:0 }} mouseMoved={setV} className="polar-demo">
